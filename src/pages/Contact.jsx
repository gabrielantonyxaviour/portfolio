      ...
      <div className="max-w-[1200px] mt-[200px]  mx-auto w-full flex flex-col justify-start">
        <div className="mx-auto h-[400px] flex flex-col select-none text-[#A9A9A9]">
          <div className="flex justify-around text-center">
            <p className=" text-sm w-[160px] mx-4 mt-5">
              You looking for a good developer
            </p>
            <p className="  text-sm w-[150px] mx-4 mt-5">
        ...
        <div
          ...
          className="mt-[90px] h-[75px] w-[80%] lg:w-[50%]   bg-[#D22B2B] mx-auto rounded-2xl cursor-pointer shadow-md fill-white hover:fill-black shadow-red-500/50  hover:shadow-white transition ease-in-out delay-50 hover:-translate-y-1 hover:scale-103 hover:bg-white hover:text-[#000000] duration-300"
        >
