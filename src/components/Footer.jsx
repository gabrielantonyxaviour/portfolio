...
function InstagramIcon(props) {
  return (
    <svg
      ...
      {...props}
      onClick={() => {
        window.open("https://www.instagram.com/gabrielaxy.eth/", "_blank");
      }}
    >
...
function GitHubIcon(props) {
  return (
    <svg
      ...
      {...props}
      onClick={() => {
        window.open("https://github.com/gabrielantonyxaviour", "_blank");
      }}
    >
      <path
        fillRule="evenodd"
...
function LinkedInIcon(props) {
  return (
    <svg
      ...
      {...props}
      onClick={() => {
        window.open("https://www.linkedin.com/in/gabriel-antony/", "_blank");
      }}
    >
...
function DiscordIcon(props) {
  return (
    <svg
      ...
      onClick={() => {
        window.open(
          "https://discordapp.com/users/562735785476882454",
          "_blank"
        );
      }}
    >
...
function TwitterIcon(props) {
  return (
    <svg
      ...
      {...props}
      onClick={() => {
        window.open("https://twitter.com/gabrielaxyeth", "_blank");
      }}
    >
